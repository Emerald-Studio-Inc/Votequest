...
interface FlutterWaveCoinsPurchaseModalProps {
    userId: string;
    isOpen: boolean;
    onClose: () => void;
...
const FlutterWaveCoinsPurchaseModal: React.FC<FlutterWaveCoinsPurchaseModalProps> = (props) => {
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    {COIN_PACKAGES.map((pkg) => (
                        ...
                        >
                            ...
                            <p className="text-sm text-mono-70">₦{(pkg.price / 100).toLocaleString()}</p>
                        </button>
                    ))}
                </div>
...
export default FlutterWaveCoinsPurchaseModal;
